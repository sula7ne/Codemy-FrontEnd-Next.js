        ...
        <button tabIndex={0} onClick={handleSaveCourse} className={clsx(styles.btn, styles.save)}>
            <div className={styles.icon}>
                {isSaved ? 
                    ...
                    :
                    <svg viewBox="0 0 512 512" height="24" width="24" fill="none" stroke="currentColor" strokeWidth="32" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" d="M352 48H160a48 48 0 0 0-48 48v368l144-128 144 128V96a48 48 0 0 0-48-48z"/></svg>
                }
            </div>
        </button>
    );
