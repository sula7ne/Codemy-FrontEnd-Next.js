...
const CourseHeader = ({ course }: ICourseHeaderProps) => {
        ...
        <div className={styles.header}>
            ...
            <div className={styles.info}>
                ...
                <div className={styles.actions}>
                    <StartCourseBtn status={course?.myProgress?.status || 'NOT_STARTED'} handleStartCourse={handleStartCourse} />

                    <SaveCourseBtn isSaved={course?.myProgress?.isSaved || false} handleSaveCourse={handleSaveCourse} />
                </div>
            </div>
